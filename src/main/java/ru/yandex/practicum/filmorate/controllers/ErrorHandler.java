...
public class ErrorHandler {
    ...
    public ErrorResponse handleFilmDontExistException(final FilmDontExistException e) {
        return new ErrorResponse(e.getMessage());
    }
    ...
    @ExceptionHandler
    @ResponseStatus(HttpStatus.NOT_FOUND)
    public ErrorResponse handleUserDontExistException(final UserDontExistException e) {
        return new ErrorResponse(e.getMessage());
    }
